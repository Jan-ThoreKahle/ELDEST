...
outfile.write("The results were obtained with time_save_measure_TK.py \n")
#-------------------------------------------------------------------------
# set some defaults
Xshape = 'convoluted'
...
#            outfile.write(str(Ekins1[max_pos[i]]) + '  ' + str(squares[max_pos[i]]) + '\n')
    #print "vor dem naechsten Zeitschritt"

    t_au = t_au + timestep_au


#print "nach dem ersten Teil"
#-------------------------------------------------------------------------
